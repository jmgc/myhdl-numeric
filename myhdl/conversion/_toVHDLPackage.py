...
package pck_myhdl_%(version)s is
    ...
    function tern_op(cond: boolean; if_true: std_logic_vector; if_false: std_logic_vector) return std_logic_vector;
...
"""
    ...
    function c_n2u (arg: natural; size: natural) return unsigned;
...
package body pck_myhdl_%(version)s is
    ...
    function tern_op(cond: boolean; if_true: std_logic_vector; if_false: std_logic_vector) return std_logic_vector is
    begin
        if cond then
            return if_true;
        else
...
"""
    ...
    function c_n2u (arg: natural; size: natural) return unsigned is
        constant high: natural := ceil_log2(natural'high);
