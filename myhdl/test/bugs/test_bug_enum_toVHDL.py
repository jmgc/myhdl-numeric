...
from myhdl import enum, always_comb, Signal, toVHDL
...
def test_bug_enum_toVHDL():
    toVHDL(pcie_legacyint_next_state_logic, state, next_state, next_state_en,
           interrupt_pending, interrupt_assert)
