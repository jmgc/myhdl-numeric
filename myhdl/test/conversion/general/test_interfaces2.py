...
from myhdl import intbv, Signal, always_seq, always_comb, instance, \
    ResetSignal, delay, Simulation, StopSimulation
...
def name_conflict_after_replace(clock, reset, a, a_x):
    a_x_renamed0 = [Signal(intbv(0)[len(a_x):]) for _ in range(8)]
